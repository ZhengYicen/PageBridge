...
from backend.auth import current_user, require_book_owner, require_chapter_owner
...
async def get_paragraph_translations(chapter_id: str, user: dict = Depends(current_user)):
    """
    获取章节所有段落的翻译状态（轮询用）。
